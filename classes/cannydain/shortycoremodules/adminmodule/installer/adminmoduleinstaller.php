...
namespace CannyDain\ShortyCoreModules\AdminModule\Installer;

use CannyDain\Shorty\Modules\Interfaces\ModuleInstallerInterface;
use CannyDain\Lib\Forms\Models\InputField;

class AdminModuleInstaller implements ModuleInstallerInterface
{
    public function getName() { return "AdminModule"; }
