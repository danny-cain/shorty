<?php
namespace CannyDain\ShortyCoreModules\Contact;
...
use CannyDain\ShortyCoreModules\Contact\Installer\ContactInstaller;

class ContactModule extends BaseModule implements DependencyConsumer
{
    /**
     ...
     */
    public function getInstaller() { return new ContactInstaller(); }
    ...
    public function getInfo()
    {
        ...
        $info->setName("Contact Form");
        $info->setReleaseDate(1373628628);
