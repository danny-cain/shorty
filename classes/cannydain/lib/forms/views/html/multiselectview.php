...
class MultiSelectView extends HTMLMultiInputView
{
    protected function _displayIndividualElements()
    {
        echo '<div class="formRow">';
            echo '<span class="input">';
                ...
                {
                    $selected = '';
                    if (in_array($val, $this->_field->getValue()))
                        $selected = ' checked="checked"';

                    echo '<span class="formOption">';
                        echo '<input type="checkbox" name="'.$this->_field->getName().'[]" value="'.$val.'" '.$selected.' />';
                        echo $caption;
                    echo '</span>';
                }
            echo '</span>';
    ...
    protected function _displaySelect()
    {
        echo '<div class="formRow">';
            ...
            echo '<span class="input">';
                echo '<select mulitple name="'.$this->_field->getName().'[]">';
                    foreach ($this->_field->getOptions() as $val => $caption)
                    {
                        $selected = '';
